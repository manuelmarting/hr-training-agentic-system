...
from app.agent.tools.extract_facts import extract_and_gate_fact, gate_fact
...
async def test_extract_and_gate_fact_stores_allowlisted_fact():
    ...
    from app.agent.tools.extract_facts import _FactExtraction, _SpecialCategoryCheck
...
async def test_special_category_disclosure_blocked_at_pattern_stage_no_llm_call():
    from app.agent.tools.extract_facts import _FactExtraction
...
async def test_special_category_disclosure_blocked_at_llm_stage():
    ...
    from app.agent.tools.extract_facts import _SpecialCategoryCheck
